...
__forceinline  unsigned int CRCSecthion(PVOID base, const char* secthionName)
{
	...
	for (auto i = 0; i < headers->FileHeader.NumberOfSections; ++i)
	{
		...
		if (ApiWrapper::memcmp(section->Name, secthionName, ApiWrapper::strlen(secthionName)) == 0)
		{
